  ...
  <![endif]-->
    ...
    <tr>
      <td role="module-content">
        <p>Active your newly registered account</p>
      </td>
    </tr>
  </table><table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="f7162f4d-07e6-4666-8ef7-cee7d0928e4e" data-mc-module-version="2019-10-22">
    <tbody>
      <tr>
...
<div style="font-family: inherit; text-align: inherit">You or someone just registered a new NotionalApi account with this email.</div>
<div style="font-family: inherit; text-align: inherit">Your have 24h to to active your account by follow the link bellow</div><div></div></div></td>
      </tr>
    </tbody>
  </table><table border="0" cellpadding="0" cellspacing="0" class="module" data-role="module-button" data-type="button" role="module" style="table-layout:fixed;" width="100%" data-muid="b395749c-e47d-4181-a2d9-586c3904475b">
      <tbody>
        <tr>
...
export const sendMailResetPassword = async (recipient, activation_url) => {
  const text = `Active your newly registered account
Hello,
You or someone just made a request to reset password of a NotionalApi account with this email.
Your have 24h to to reset your password by follow the link bellow
Reset Password Now (${activation_url})
If it wasnt you, please ignore this email.
Thank you,
...
<![endif]-->
  ...
  <![endif]-->
    ...
    <tbody>
      <tr>
        <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit">Hello,</div>
<div style="font-family: inherit; text-align: inherit">You or someone just made a request to reset password of a NotionalApi account with this email.</div>
<div style="font-family: inherit; text-align: inherit">Your have 24h to to reset your password by follow the link bellow</div><div></div></div></td>
      </tr>
    </tbody>
  </table><table border="0" cellpadding="0" cellspacing="0" class="module" data-role="module-button" data-type="button" role="module" style="table-layout:fixed;" width="100%" data-muid="b395749c-e47d-4181-a2d9-586c3904475b">
      <tbody>
...
<div style="font-family: inherit; text-align: start"><span style="box-sizing: border-box; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; font-style: inherit; font-variant-ligatures: inherit; font-variant-caps: inherit; font-variant-numeric: inherit; font-variant-east-asian: inherit; font-weight: inherit; font-stretch: inherit; line-height: inherit; font-family: inherit; font-size: 14px; vertical-align: baseline; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-top-style: initial; border-right-style: initial; border-bottom-style: initial; border-left-style: initial; border-top-color: initial; border-right-color: initial; border-bottom-color: initial; border-left-color: initial; border-image-source: initial; border-image-slice: initial; border-image-width: initial; border-image-outset: initial; border-image-repeat: initial; color: #000000; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: pre-wrap; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial">Thank you,</span></div><div></div></div></td>
  ...
  const msg = {
    to: recipient,
    from: 'noreply@notionalapi.com',
    subject: 'Reset Password your NotionalApi account',
    text,
    html,
  }
